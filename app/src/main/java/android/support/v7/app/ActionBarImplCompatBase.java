...
class ActionBarImplCompatBase extends ActionBar {
    ...
    private void init(ActionBarPreferenceActivity activity) {
        mOverlayLayout = (ActionBarOverlayLayout) activity.findViewById(
                android.support.v7.appcompat.R.id.action_bar_overlay_layout);
        if (mOverlayLayout != null) {
            mOverlayLayout.setActionBar(this);
        }
        mActionView = (ActionBarView) activity.findViewById(android.support.v7.appcompat.R.id.action_bar);
        mContextView = (ActionBarContextView) activity.findViewById(android.support.v7.appcompat.R.id.action_context_bar);
        mContainerView = (ActionBarContainer) activity.findViewById(android.support.v7.appcompat.R.id.action_bar_container);
        mTopVisibilityView = (ViewGroup) activity.findViewById(android.support.v7.appcompat.R.id.top_action_bar);
        if (mTopVisibilityView == null) {
            mTopVisibilityView = mContainerView;
        }
        mSplitView = (ActionBarContainer) activity.findViewById(android.support.v7.appcompat.R.id.split_action_bar);
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (animate) {
            Animation anim = AnimationUtils.loadAnimation(mContext, android.support.v7.appcompat.R.anim.abc_slide_in_top);
        ...
        if (mSplitView != null && mSplitView.getVisibility() != View.VISIBLE) {
            if (animate) {
                Animation anim = AnimationUtils.loadAnimation(mContext, android.support.v7.appcompat.R.anim.abc_slide_in_bottom);
    ...
    public void doHide(boolean fromSystem) {
        ...
        if (animate) {
            Animation anim = AnimationUtils.loadAnimation(mContext, android.support.v7.appcompat.R.anim.abc_slide_out_top);
            mTopVisibilityView.startAnimation(anim);
        }
        ...
        if (mSplitView != null && mSplitView.getVisibility() != View.GONE) {
            if (animate) {
                Animation anim = AnimationUtils
                        .loadAnimation(mContext, android.support.v7.appcompat.R.anim.abc_slide_out_bottom);
                mSplitView.startAnimation(anim);
            }
