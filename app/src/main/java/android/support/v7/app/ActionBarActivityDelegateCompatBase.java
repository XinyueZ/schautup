...
public class ActionBarActivityDelegateCompatBase  extends ActionBarActivityDelegateCompat implements
    ...
    public void setContentView(View v) {
        ...
        if (mHasActionBar) {
            final ViewGroup contentParent =
                    (ViewGroup) mActivity.findViewById(android.support.v7.appcompat.R.id.action_bar_activity_content);
        ...
        if (mHasActionBar && !mSubDecorInstalled) {
	        ...
	        if (mOverlayActionBar) {
		        ViewGroup decor = (ViewGroup) mActivity.getLayoutInflater().inflate(
				        android.support.v7.appcompat.R.layout.abc_action_bar_decor_overlay, null);
		        decor.addView(listView);
		        mActivity.superSetContentView(decor);
	        } else {
		        ViewGroup decor = (ViewGroup) mActivity.getLayoutInflater().inflate(android.support.v7.appcompat.R.layout.abc_action_bar_decor,
				        null);
		        decor.addView(listView);
		        mActivity.superSetContentView(decor);
	        }
            ...
            if (splitWhenNarrow) {
                splitActionBar = mActivity.getResources()
                        .getBoolean(android.support.v7.appcompat.R.bool.abc_split_action_bar_is_narrow);
            } else {
                TypedArray a = mActivity.obtainStyledAttributes(android.support.v7.appcompat.R.styleable.ActionBarWindow);
                splitActionBar = a
                        .getBoolean(android.support.v7.appcompat.R.styleable.ActionBarWindow_windowSplitActionBar, false);
                a.recycle();
            }

            final ActionBarContainer splitView = (ActionBarContainer) mActivity.findViewById(
                    android.support.v7.appcompat.R.id.split_action_bar);
            if (splitView != null) {
                ...
                final ActionBarContextView cab = (ActionBarContextView) mActivity.findViewById(
                        android.support.v7.appcompat.R.id.action_context_bar);
    ...
    private MenuView getListMenuView(Context context, MenuPresenter.Callback cb) {
        ...
        if (mListMenuPresenter == null) {
            TypedArray a = context.obtainStyledAttributes(android.support.v7.appcompat.R.styleable.Theme);
            final int listPresenterTheme = a.getResourceId(
                    android.support.v7.appcompat.R.styleable.Theme_panelMenuListTheme,
                    android.support.v7.appcompat.R.style.Theme_AppCompat_CompactMenu);
            a.recycle();

            mListMenuPresenter = new ListMenuPresenter(
                    android.support.v7.appcompat.R.layout.abc_list_menu_item_layout, listPresenterTheme);
    ...
    private ProgressBarICS getCircularProgressBar() {
        ProgressBarICS pb = (ProgressBarICS) mActionBarView.findViewById(android.support.v7.appcompat.R.id.progress_circular);
        if (pb != null) {
    ...
    private ProgressBarICS getHorizontalProgressBar() {
        ProgressBarICS pb = (ProgressBarICS) mActionBarView.findViewById(android.support.v7.appcompat.R.id.progress_horizontal);
        if (pb != null) {
            pb.setVisibility(View.INVISIBLE);
        }
        return pb;
